...
const Banner = () => {
  ...
  return (
    <section className='bg-rs bg-cover bg-no-repeat bg-left bg-neutral-500 absolute top-0 left-0 w-screen h-screen' id='banner'> {/*Diminuição da alturado baner para poder puxar o conteúdo mais pra cima e ma*/}
