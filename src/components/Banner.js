...
const Banner = () => {
  ...
  return (
    <section className='bg-rs bg-no-repeat bg-left-top bg-smaller bg-neutral-500 h-screen' id='banner'>
      <div className='md:container md:mx-auto h-full'>
        <div className='flex items-center h-full relative lg:-space-x-24 w-full px-[10%] md:p-0'>
          ...
          <div 
            className={`bg-banner bg-cover bg-no-repeat bg-left-top bg-center ${windowWidth <= 769 ? 
