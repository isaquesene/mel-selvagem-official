...
const Banner = () => {
  ...
  return (
    <section className='bg-banner bg-cover bg-no-repeat bg-left bg-neutral-500 h-screen' id='banner'> {/*Diminuição da alturado baner para poder puxar o conteúdo mais pra cima e ma*/}
