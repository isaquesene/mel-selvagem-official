...
const Community = () => {
  ...
  return (
    <section className='section relative pt-[140px] sm:mx-[20px] pb-0' id='community'>
        <div className='flex lg:flex-row flex-col justify-around mx-4 sm:px[20px]'>
          {/* section title */}
          ...
          {/* slider */}
          <div className='relative lg:w-[70%] lg:top-0 p-1'
            data-aos='fade-left'
            data-aos-offset='200'
            data-aos-delay='300'
          >
